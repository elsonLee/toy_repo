...
int main ()
{
    ...
    static_assert(ADD(w_[rax + rcx * Imm8<2> + Imm8<0x34>], Imm8<0x12>)	    == make_bytes<0x66, 0x83, 0x44, 0x48, 0x34, 0x12>());
    static_assert(ADD(w_[rax + rcx * Imm8<4> + Imm8<0x34>], Imm8<0x12>)     == make_bytes<0x66, 0x83, 0x44, 0x88, 0x34, 0x12>());
    static_assert(ADD(w_[rax + rcx * Imm8<8> + Imm8<0x34>], Imm8<0x12>)     == make_bytes<0x66, 0x83, 0x44, 0xc8, 0x34, 0x12>());
